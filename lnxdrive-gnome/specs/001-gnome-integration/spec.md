...
- **FR-024**: Toda la comunicación entre los componentes de la interfaz GNOME y el daemon DEBE realizarse a través de la API D-Bus definida por el proyecto (`com.strangedaystech.LNXDrive`).
...
- El daemon de LNXDrive (`lnxdrive-daemon`) y la API D-Bus (`com.strangedaystech.LNXDrive`) ya existen y están funcionales (entregados en Fases 1-2).
