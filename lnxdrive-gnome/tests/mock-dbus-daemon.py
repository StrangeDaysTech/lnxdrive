...
Implements all 7 D-Bus interfaces of com.strangedaystech.LNXDrive on the session bus:
  - com.strangedaystech.LNXDrive.Files
...
# ===================================================================
# 1. com.strangedaystech.LNXDrive.Files
# ===================================================================
class FilesInterface(ServiceInterface):
    """Mock implementation of com.strangedaystech.LNXDrive.Files."""

    def __init__(self, sync_root: str) -> None:
        super().__init__("com.strangedaystech.LNXDrive.Files")
...
# ===================================================================
# 2. com.strangedaystech.LNXDrive.Sync
# ===================================================================
class SyncInterface(ServiceInterface):
    """Mock implementation of com.strangedaystech.LNXDrive.Sync."""

    def __init__(self) -> None:
        super().__init__("com.strangedaystech.LNXDrive.Sync")
...
# ===================================================================
# 3. com.strangedaystech.LNXDrive.Status
# ===================================================================
class StatusInterface(ServiceInterface):
    """Mock implementation of com.strangedaystech.LNXDrive.Status."""

    def __init__(self) -> None:
        super().__init__("com.strangedaystech.LNXDrive.Status")
...
# ===================================================================
# 4. com.strangedaystech.LNXDrive.Manager
# ===================================================================
class ManagerInterface(ServiceInterface):
    """Mock implementation of com.strangedaystech.LNXDrive.Manager."""

    def __init__(self) -> None:
        super().__init__("com.strangedaystech.LNXDrive.Manager")
...
# ===================================================================
# 5. com.strangedaystech.LNXDrive.Conflicts
# ===================================================================
class ConflictsInterface(ServiceInterface):
    """Mock implementation of com.strangedaystech.LNXDrive.Conflicts."""

    def __init__(self, sync_root: str) -> None:
        super().__init__("com.strangedaystech.LNXDrive.Conflicts")
        self._sync_root = sync_root
...
# ===================================================================
# 6. com.strangedaystech.LNXDrive.Settings
# ===================================================================
...
class SettingsInterface(ServiceInterface):
    """Mock implementation of com.strangedaystech.LNXDrive.Settings."""

    def __init__(self, sync_root: str) -> None:
        super().__init__("com.strangedaystech.LNXDrive.Settings")
...
# ===================================================================
# 6. com.strangedaystech.LNXDrive.Auth
# ===================================================================
class AuthInterface(ServiceInterface):
    """Mock implementation of com.strangedaystech.LNXDrive.Auth."""
...
async def run(args: argparse.Namespace) -> None:
    ...
    log.info("=" * 60)
    log.info("Interfaces:")
    log.info("  - com.strangedaystech.LNXDrive.Files")
    log.info("  - com.strangedaystech.LNXDrive.Sync")
    log.info("  - com.strangedaystech.LNXDrive.Status")
    log.info("  - com.strangedaystech.LNXDrive.Manager")
    log.info("  - com.strangedaystech.LNXDrive.Conflicts")
    log.info("  - com.strangedaystech.LNXDrive.Settings")
    log.info("  - com.strangedaystech.LNXDrive.Auth")
