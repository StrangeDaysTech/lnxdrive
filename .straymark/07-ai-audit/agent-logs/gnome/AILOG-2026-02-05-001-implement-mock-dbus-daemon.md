...
- **Interface naming**: Interface names match the D-Bus contract exactly (e.g., `com.strangedaystech.LNXDrive.Files`), registered at the canonical object path `/org/strangedaystech/LNXDrive`.
