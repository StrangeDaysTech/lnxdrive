...
2. Run `dbus-monitor --session "interface='com.strangedaystech.LNXDrive.Auth'"`
...
#### Proposed Fix
Add versioned interfaces (com.strangedaystech.LNXDrive.Manager.1, etc.)
...
*StrayMark Framework | https://strangedays.tech*
