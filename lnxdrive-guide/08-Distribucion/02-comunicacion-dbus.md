...
```xml
<!-- com.strangedaystech.LNXDrive.xml -->
...
```xml
<!-- com.strangedaystech.LNXDrive.Accounts -->
<interface name="com.strangedaystech.LNXDrive.Accounts">
  <!-- Gestion de cuentas -->
...
|----------|-------------|---------------------|
| `com.strangedaystech.LNXDrive.Manager` | Control del daemon | Start, Stop, Restart, GetStatus |
| `com.strangedaystech.LNXDrive.Sync` | Control de sincronizacion | SyncNow, Pause, Resume, SyncPath |
| `com.strangedaystech.LNXDrive.Files` | Operaciones de archivos | GetFileStatus, PinFile, UnpinFile, FreeSpace |
| `com.strangedaystech.LNXDrive.Status` | Informacion de estado | GetQuota, GetAccountInfo |
| `com.strangedaystech.LNXDrive.Accounts` | Gestion multi-cuenta | ListAccounts, AddAccount, RemoveAccount |
...
<policyconfig>
  ...
  <action id="com.strangedaystech.lnxdrive.sensitive">
    ...
    <annotate key="org.freedesktop.policykit.imply">
      com.strangedaystech.lnxdrive.admin
    </annotate>
  </action>
</policyconfig>
```
...
<interface name="com.strangedaystech.LNXDrive.Sync2">
