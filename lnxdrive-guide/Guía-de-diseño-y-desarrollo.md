...
| **Revisar riesgos del componente** | Sección "⚠️ Riesgos y Mitigaciones" en cada archivo `04-Componentes/*.md`. Matriz completa: `.straymark/02-design/risk-analysis/TRACE-risks-mitigations.md` |
