...
**Proof of Concept:**
```bash
dbus-monitor --session "interface='org.strangedaystech.LNXDrive.Auth'"
...
dbus-send --session --dest=org.strangedaystech.LNXDrive \
  /org/strangedaystech/LNXDrive/Manager \
  org.strangedaystech.LNXDrive.Manager.ResetSync
```
...
<interface name="org.strangedaystech.LNXDrive.Manager">
  ...
  <method name="RemoveAccountSecure">
    ...
    <annotation name="org.freedesktop.policykit1.action"
                value="org.strangedaystech.lnxdrive.remove-account"/>
  </method>
</interface>
```
...
while true; do
  dbus-send --session --dest=org.strangedaystech.LNXDrive \
    ...
    org.strangedaystech.LNXDrive.Sync.GetStatus &
done
```
...
*DevTrail Framework | https://strangedaystech.com*
